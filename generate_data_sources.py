...
markdown_content = """# DATA_SOURCES.md — Project Arnab Data Provenance & Methodology
...
# ফাইল রাইট অপারেশন
output_path = "DATA_SOURCES.md"
with open(output_path, "w", encoding="utf-8") as f:
    f.write(markdown_content.strip())

print(f"[✓] Successfully generated NASA Data Provenance Document: {os.path.abspath(output_path)}")
